 ...
 * @version 1.0
 */
public interface ServerDeploymentHandler extends Remote, Serializable
{
    /**
     ...
     */
    Server obtainPort(String host) throws RemoteException;
     ...
     *
     * @param self The {@link Server} object given by {@link #obtainPort(String)}.
